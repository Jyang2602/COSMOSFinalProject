...
public class StarDataHolder
{
    ...
    {
        FileWriter fileWriter = new FileWriter("CRE_DataRawwStar.xls");
    ...
    {
        FileWriter fileWriter = new FileWriter("CRE_DatawStar.xls");
        PrintWriter printWriter = new PrintWriter(fileWriter);
    ...
    public void writeNormalized() throws IOException
    {
        ...
        FileWriter fileWriter = new FileWriter("CRE_DataNormalizedwStar.xls");
        PrintWriter printWriter = new PrintWriter(fileWriter);
