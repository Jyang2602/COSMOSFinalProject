...
public class NumScanner
{
    ...
    private boolean eof;
    private int lineNum;
    private StarDataHolder_More curr;
     ...
     */
    public NumScanner(InputStream inStream, StarDataHolder_More data)
    {
        lineNum = 1;
     ...
     *            the string to scan
     */
    public NumScanner(String inString, StarDataHolder_More data)
    {
        lineNum = 0;
     ...
     * @throws ScanErrorException if file has unknown character
     */
    private void eatSpace() throws ScanErrorException 
    {
    ...
    public KnotTransition nextKnot() throws IOException, ScanErrorException
    {
        ...
        if(isDigit(currentChar))
        {
            ...
            return new KnotTransition(Double.parseDouble(temp), starred, Integer.parseInt(numK));
        }
        ...
        if (isLetter(currentChar))
        {
            ...
            return new KnotTransition("s", Integer.parseInt(numK));
        }
        else
        {
